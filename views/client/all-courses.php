                   ...
                   <?php else: ?>
                       <?php foreach ($playlists as $playlist): ?>
                           ...
                           if (!empty($playlist['cover_image'])) {
                               // Si la imagen ya tiene el prefijo public/, no agregarlo de nuevo
                               if (strpos($playlist['cover_image'], 'public/') === 0) {
                                   $imageUrl = '../../' . $playlist['cover_image'];
                               } else {
                                   $imageUrl = '../../public/' . $playlist['cover_image'];
                               }
                           } elseif (!empty($playlist['thumbnail'])) {
                               // Intentar con thumbnail si cover_image no existe
                               if (strpos($playlist['thumbnail'], 'public/') === 0) {
                                   $imageUrl = '../../' . $playlist['thumbnail'];
                               } else {
                                   $imageUrl = '../../public/' . $playlist['thumbnail'];
                               }
                           }
                           ?>
