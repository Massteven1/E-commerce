  ...
  <div class="container">
      <div class="form-grid">
          <div class="checkout-section">
              ...
              <form action="index.php?controller=playlist&action=create" method="post" enctype="multipart/form-data" class="form-row">
                  ...
                  <?php foreach ($playlists as $playlist): ?>
                      <div class="product-card">
                          ...
                          <div class="product-details">
                              ...
                              <h4><a href="index.php?controller=video&action=view_playlist&id=<?php echo htmlspecialchars($playlist['id']); ?>"><?php echo htmlspecialchars($playlist['name']); ?></a></h4>
                              ...
                              <div class="product-bottom-details">
                                  ...
                                  <div class="product-links">
                                      <a href="index.php?controller=playlist&action=edit&id=<?php echo htmlspecialchars($playlist['id']); ?>" title="Editar"><i class="fa fa-edit"></i></a>
                                      <a href="index.php?controller=video&action=view_playlist&id=<?php echo htmlspecialchars($playlist['id']); ?>" title="Ver Videos"><i class="fa fa-eye"></i></a>
                                      <a href="index.php?controller=playlist&action=delete&id=<?php echo htmlspecialchars($playlist['id']); ?>" title="Eliminar" onclick="return confirm('¿Estás seguro de que quieres eliminar esta lista de reproducción y todos sus videos asociados? Esta acción es irreversible.');"><i class="fa fa-trash-alt" style="color: var(--red-color);"></i></a>
                                  </div>
                              </div>
                          </div>
                      </div>
